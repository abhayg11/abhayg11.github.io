---
layout: page
title: Macaulay2 \| Hello World
---

Examples of constructing rings and finding dimensions:
```
p = 5
S = ZZ/p[x,y,z]
I = ideal(x^2-y*z)
...
Examples of creating ring homomorphisms:
```
p = 5
S = ZZ/p[x,y,z]
A = ZZ/p[a,b]
...
And creating rings/modules as images of homs:
```
