...
\begin{proof}
	...
	\[ [\QQ(\omega) : \QQ] = \frac{[\QQ(\zeta_{p^r}) : \QQ][\QQ(\zeta_n) : \QQ]}{[\QQ(\zeta_{p^r}) \cap \QQ(\zeta_n) : \QQ]} \]
	since the subextensions are Galois.
\end{proof}
